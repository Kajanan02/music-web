        ...
        <div class="col-md-6 d-flex align-items-center justify-content-center">
            <form class="mx-5 my-5 px-5" method="POST" action="./artist-payment.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control bg-dark text-white place-holder" placeholder="Enter email here..." id="exampleInputEmail1" aria-describedby="emailHelp" required>
                    <div id="emailHelp" class="form-text text-white">We'll never share your email with anyone else.</div>
                </div>

                <div class="mb-3">
                    <label for="city" class="form-label text-white">City</label>
                    <input type="text" name="city" class="form-control bg-dark text-white place-holder" placeholder="Enter the main city you're based in" id="city" aria-describedby="emailHelp" required>
                </div>

                <div class="mb-3">
                    <label for="coutry" class="form-label text-white">Country</label>
                    <select name="country" class="form-control bg-dark text-white place-holder" id="country" required>
