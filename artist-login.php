    ...
    <div class=" bg-dark">
        <div class="row m-0 artist-login-container">
            <div class="col-md-6 d-flex align-items-md-end artist-login-image">
                <img src="assets/artist03.png" width="90%" style="z-index: 1">
                <img src="assets/play-btn-3.png" width="100%" class="bg-play">
            </div>
            ...
            <div class="col-md-6 align-items-center justify-content-center">
                ...
                <form class="mx-5 my-5 px-5" method="POST" action="./scripts/prcoess-login.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="password" class="form-control bg-dark place-holder text-white" placeholder="Enter password" id="exampleInputPassword1">
                    </div>
